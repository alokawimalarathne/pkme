...
<div class="row">
	<div class="span6">
            <form class="form-horizontal" method="post" action="studentSignup.php" id="sign-up-form">
			<fieldset>
				...
				<div class="control-group" id="usrCheck">
					...
					<div class="controls">
						<input type="text" class="input-xlarge" id="username" name="username" maxlength="15" value="<?php echo $signUp->getPost('username'); ?>" placeholder="<?php _e('Choose your username'); ?>">
                                ...
                                <div class="control-group" id="usrCheck">
					<label class="control-label" for="registration_number"><?php _e('Registration number'); ?></label>				
					<div class="controls">
						<input type="text" class="input-xlarge" id="registration_number" name="registration_number" maxlength="15" value="<?php echo $signUp->getPost('registration_number'); ?>" placeholder="<?php _e('Enter your registration_number'); ?>">
					</div>        
				</div>
				<div class="control-group">
	...
	<div class="span6">
		<h1><?php _e('You are going to register as a student'); ?></h1>
                <a class="brand" href="home.php"><img src="images/student.jpg" width="550" height="300"/></a>
		<p><?php _e(''); ?></p>
		<h2><?php _e(''); ?></h2>
		<p><?php _e(''); ?></p>
	</div>
