            ...
            <div class="tab-pane fade useredit in active" id="usr-control">
                    <div class="col-md-12">	
                        ...
                        <div class="form-group col-xs-4">
                            ...
                            <input type="tel"  autocomplete="off" pattern="^\d{4}\d{2}\d{4}$" class="form-control" id="mobile" name="mobile" placeholder="<?php _e('Please enter valide mobile number'); ?>" value="<?php echo $profile->getField('mobile'); ?>">
