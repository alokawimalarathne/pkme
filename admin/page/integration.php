...
<fieldset>
	...
	<div class="control-group">
		<label class="control-label" for="integration-playThru-enable"><a href="http://areyouahuman.com/?utm_source=Pickme&utm_medium=Pickme&utm_campaign=Pickme"><?php _e('PlayThru'); ?></a></label>
		<div class="controls">
			...
			<p><?php echo sprintf(_('You must first <a href="%s">signup to get a site key</a>.'), 'http://portal.areyouahuman.com/signup?utm_source=Pickme&utm_medium=Pickme&utm_campaign=Pickme'); ?></p>
