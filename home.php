<?php include_once('header.php'); ?>
	...
	<div class="row">
            ...
            <div class="span6">
                ...
                <div> <?php _e('Welcome , '); echo $_SESSION['pickme']['username']; ?></div>
                <?php }else{ ?>
...
<div class="row">
	<div class="main login">
		...
		<fieldset>
		<h4><?php _e('Sign in to Pickme'); ?></h4>
			...
			<label for="password" class="login-label"><?php _e('Password'); ?></label>
				<div class="controls">
                    ...
                    <input type="hidden" name="token" value="<?php if(isset($_SESSION['pickme']['token'])) echo $_SESSION['pickme']['token']; ?>"/>
