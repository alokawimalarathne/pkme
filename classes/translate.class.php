...
class Translate {
	...
	private function setLang() {
		...
		if ( !empty($_GET['lang']) ) :
			...
			if ( $this->displayName($lang) ) :
				$this->lang = $lang;
				$_SESSION['pickme']['language'] = $lang;
			endif;

		endif;

		$this->lang = !empty($_SESSION['pickme']['language']) ? $_SESSION['pickme']['language'] : $this->lang;
	...
	public function languageSelector() {
		...
		foreach ( $options as $code => $language ) {
			...
			$selected = ( !empty($_SESSION['pickme']['language']) && $_SESSION['pickme']['language'] == $code ) ? 'selected="selected"' : '';
